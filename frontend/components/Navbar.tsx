                    ...
                    <div className="bg-black/60 backdrop-blur-2xl border border-amber-500/20 rounded-2xl px-6 py-3 flex items-center justify-between shadow-2xl shadow-amber-500/5">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div className="hidden md:flex items-center gap-2">
                                ...
                                <Link
                                    href="https://chat.whatsapp.com/EuNhXQkwy7Y4ELMjB1oVPd?mode=gi_t"
                                    target="_blank"
                                ...
                                >
                                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                                        <path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0 0 12.04 2zm.01 1.67c2.2 0 4.26.86 5.82 2.42 1.55 1.56 2.41 3.63 2.41 5.83s-.86 4.27-2.41 5.83c-1.55 1.56-3.62 2.42-5.82 2.42-1.45 0-2.81-.37-4.04-1.07l-.29-.17-3 .79.8-2.92-.18-.3c-.76-1.2-1.17-2.58-1.17-4.01 0-4.54 3.7-8.24 8.24-8.24zM8.38 7.3c-.15 0-.39.05-.59.26-.2.21-.77.75-.77 1.83 0 1.08.79 2.12.91 2.27.11.15 1.56 2.38 3.79 3.34.53.23.94.37 1.27.47.53.17 1.02.14 1.4.09.43-.06 1.32-.54 1.51-1.06.18-.53.18-.98.13-1.06-.05-.08-.19-.13-.41-.24-.22-.11-1.32-.65-1.53-.72-.2-.07-.35-.11-.5.09-.15.21-.57.72-.7.86-.13.15-.26.17-.48.06-.22-.11-.93-.34-1.78-1.1s-1.41-1.68-1.58-1.95c-.17-.27-.02-.42.12-.56.12-.11.27-.3.41-.46.14-.15.18-.27.27-.45.09-.17.05-.33-.02-.45-.07-.11-.59-1.43-.81-1.97-.21-.51-.43-.44-.59-.45-.14 0-.3-.01-.46-.01z" />
                                    </svg>
                                </Link>
                            </div>
                        ...
                        >
                            ...
                            <div className="mt-8 space-y-3">
                                ...
                                <Link
                                    href="https://chat.whatsapp.com/EuNhXQkwy7Y4ELMjB1oVPd?mode=gi_t"
                                    target="_blank"
                                    className="block w-full py-3 text-center bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold rounded-xl mb-3"
                                >
                                    Join WhatsApp Group
                                </Link>
                                <Link
