...
const finalizeJobData = async (refinedData, rawData = {}) => {
    ...
    return {
        ...
        batch: parseBatches(refinedData.batch || rawData.batch),
        tags: refinedData.tags || (rawData.role ? [rawData.role] : []),
        jobType: mapJobType(refinedData.jobType || rawData.jobtype),
        roleType: refinedData.roleType || rawData.role || 'Engineering',
        seniority: refinedData.seniority || 'Entry',
        minSalary: parseMinSalary(refinedData.salary || rawData.pay || rawData.salary),
