                    ...
                    <div style="padding: 40px;">
                        ...
                        <div style="margin-top: 40px; border-top: 1px solid #f3f4f6; padding-top: 20px;">
                            ...
                            <div style="margin-top: 15px;">
                                ...
                                <a href="https://chat.whatsapp.com/EuNhXQkwy7Y4ELMjB1oVPd?mode=gi_t" style="display: inline-block; background-color: #25D366; color: white; padding: 8px 16px; border-radius: 6px; text-decoration: none; font-size: 13px; font-weight: 600; margin-right: 10px; margin-bottom: 10px;">Join WhatsApp</a>
